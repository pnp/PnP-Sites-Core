...
namespace OfficeDevPnP.Core.Tests.Framework.Providers
{
    ...
    public class XMLProvidersTests
    {
		...
		#region XML Zip Package tests

		[TestMethod]
		[TestCategory(TEST_CATEGORY)]
		public void XMLZipPackageGetTemplatesTest()
		{
			XMLTemplateProvider provider =
				new XMLZipPackageTemplateProvider(
					String.Format(@"{0}\..\..\Resources\Templates\sitetemplate.zip",
					AppDomain.CurrentDomain.BaseDirectory),
					"ProvisioningSchema-2015-05-FullSample-01");
		...
		[TestMethod]
		[TestCategory(TEST_CATEGORY)]
		public void XMLZipPackageGetTemplate1Test()
		{
			var _expectedID = "SPECIALTEAM";
			var _expectedVersion = 1.0;
			...
			XMLTemplateProvider provider =
				new XMLZipPackageTemplateProvider(
					String.Format(@"{0}\..\..\Resources\Templates\sitetemplate.zip",
					AppDomain.CurrentDomain.BaseDirectory),
					"ProvisioningTemplate-2015-03-Samples");
		...
		[TestMethod]
		[TestCategory(TEST_CATEGORY)]
		public void XMLZipPackageGetTemplate2Test()
		{
			var _expectedID = "SPECIALTEAM";
			var _expectedVersion = 1.0;
