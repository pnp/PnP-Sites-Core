# PnP Unit Test report for OnlineAppOnly on Sunday, September 6, 2015 #
...
Test run date | Sunday, September 6, 2015
Test run time | 10:06 PM
PnP branch | dev
Visual Studio build configuration | debug

## Test summary ##
During this test run 256 tests have been executed with following outcome:

Parameter | Value
----------|------
Executed tests | 256
Elapsed time | 0h 38m 20s
Passed tests | 216
Failed tests | **6**
Skipped tests | 34
Was canceled | False
...
Please contact the administrator to resolve this problem..</td></tr>
<tr><td>Tests.AppModelExtensions.TenantExtensionsTests.SubSiteExistsTest</td><td>Failed</td><td>0h 5m 3s</td><td>TestCleanup method OfficeDevPnP.Core.Tests.AppModelExtensions.TenantExtensionsTests.CleanUp threw exception. Microsoft.SharePoint.Client.ServerException: Microsoft.SharePoint.Client.ServerException: An error occurred while receiving the HTTP response to http://bot13315765-007:10000/_vti_adm/tenant.asmx. This could be due to the service endpoint binding not using the HTTP protocol. This could also be due to an HTTP request context being aborted by the server (possibly due to the service shutting down). See server logs for more details..</td></tr>
<tr><td>Tests.AppModelExtensions.TenantExtensionsTests.CreateDeleteSiteCollectionTest</td><td>Failed</td><td>0h 0m 37s</td><td>Test method OfficeDevPnP.Core.Tests.AppModelExtensions.TenantExtensionsTests.CreateDeleteSiteCollectionTest threw exception: 
...
<tr><td>Tests.AppModelExtensions.TenantExtensionsTests.SetSiteLockStateTest</td><td>Failed</td><td>0h 6m 35s</td><td>Test method OfficeDevPnP.Core.Tests.AppModelExtensions.TenantExtensionsTests.SetSiteLockStateTest threw exception: 
...
<tr><td>Tests.AppModelExtensions.TenantExtensionsTests.GetOneDriveSiteCollectionsTest</td><td>Skipped</td><td>0h 0m 41s</td><td>Assert.Inconclusive failed. Web service tests are not supported when testing using app-only</td></tr>
