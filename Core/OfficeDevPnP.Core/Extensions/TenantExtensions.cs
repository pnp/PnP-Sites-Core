...
namespace Microsoft.SharePoint.Client
{
    ...
    public static partial class TenantExtensions
    {
        ...
        public static void ApplyTemplate(this Tenant tenant, Provisioning template, ProvisioningTemplateApplyingInformation applyingInformation = null)
        {
            SiteToTemplateConversion engine = new SiteToTemplateConversion();
            engine.ApplyTenantTemplate(tenant, template, applyingInformation);
        }
        #endregion
