            ...
            using (var scope = new PnPMonitoredScope(this.Name))
            {
                if (template.Tenant != null)
                {
                    using (var tenantContext = web.Context.Clone(web.GetTenantAdministrationUrl()))
                    {
                        ...
                        TenantHelper.ProcessApps(tenant, template.Tenant, template.Connector, parser, scope, MessagesDelegate);
                        ...
                        parser = TenantHelper.ProcessStorageEntities(tenant, template.Tenant, parser, scope);
