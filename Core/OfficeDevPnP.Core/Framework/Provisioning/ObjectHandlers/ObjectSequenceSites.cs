...
namespace OfficeDevPnP.Core.Framework.Provisioning.ObjectHandlers
{
    internal class ObjectSequenceSites : ObjectSequenceHandlerBase
    {
        ...
        public override ProvisioningTemplate ExtractObjects(Tenant tenant, Model.ProvisioningHierarchy hierarchy, ProvisioningTemplateCreationInformation creationInfo)
        {
            throw new NotImplementedException();
        }

        public override TokenParser ProvisionObjects(Tenant tenant, Model.ProvisioningHierarchy hierarchy, TokenParser tokenParser, ProvisioningTemplateApplyingInformation applyingInformation)
        {
