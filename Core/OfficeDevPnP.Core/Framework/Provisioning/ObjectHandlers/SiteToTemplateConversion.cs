...
#endif
                if (creationInfo.HandlersToProcess.HasFlag(Handlers.Fields) && creationInfo.HandlersToProcess.HasFlag(Handlers.ContentTypes) && creationInfo.HandlersToProcess.HasFlag(Handlers.Lists)) objectHandlers.Add(new ObjectListInstanceDataRows());
