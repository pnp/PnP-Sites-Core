...
namespace OfficeDevPnP.Core.Framework.Provisioning.ObjectHandlers
{
    internal class ObjectPageContents : ObjectContentHandlerBase
    {
        ...
        private string TokenizeWebPartXml(Web web, string xml, bool isExtraction)
        {
            ...
            if (isExtraction) // Only do this when you are creating an export file.  SharePoint will handle the token correctly on import and if you do this you will break all JSLink & DisplayTemplate properties.
            {
                //ToDo: check this replace; it will still blindly replace all properties in the webpart with the relative web url; even JSLink will be fully replace
