...
using OfficeDevPnP.Core.Framework.Provisioning.Providers.Xml.V201612;
...
{
    internal class XMLPnPSchemaV201612Formatter : IXMLSchemaFormatter, ITemplateFormatter
    {
        ...
        public bool IsValid(Stream template)
        {
            ...
            Stream stream = typeof(XMLPnPSchemaV201612Formatter)
                .Assembly
                .GetManifestResourceStream("OfficeDevPnP.Core.Framework.Provisioning.Providers.Xml.ProvisioningSchema-2016-12.xsd");

            // Prepare the XML Schema Set
            XmlSchemaSet schemas = new XmlSchemaSet();
            schemas.Add(XMLConstants.PROVISIONING_SCHEMA_NAMESPACE_2016_12,
        ...
        Stream ITemplateFormatter.ToFormattedTemplate(Model.ProvisioningTemplate template)
        {
            ...
            V201612.ProvisioningTemplate result = new V201612.ProvisioningTemplate();

            V201612.Provisioning wrappedResult = new V201612.Provisioning();
            wrappedResult.Preferences = new V201612.Preferences
            {
                Generator = this.GetType().Assembly.FullName
            };
            wrappedResult.Templates = new V201612.Templates[] {
                new V201612.Templates
                {
                    ID = String.Format("CONTAINER-{0}", template.Id),
                    ProvisioningTemplate = new V201612.ProvisioningTemplate[]
                    {
                        result
                    }
                }
            ...
            if (template.Properties != null && template.Properties.Any())
            {
                result.Properties =
                    (from p in template.Properties
                     select new V201612.StringDictionaryItem
                     {
                         Key = p.Key,
                         Value = p.Value,
                     }).ToArray();
            ...
            if (template.PropertyBagEntries != null && template.PropertyBagEntries.Count > 0)
            {
                result.PropertyBagEntries =
                    (from bag in template.PropertyBagEntries
                     select new V201612.PropertyBagEntry()
                     {
                         Key = bag.Key,
                         Value = bag.Value,
                         Indexed = bag.Indexed,
            ...
            {
                result.WebSettings = new V201612.WebSettings
                {
            ...
            {
                result.RegionalSettings = new V201612.RegionalSettings()
                {
                    AdjustHijriDays = template.RegionalSettings.AdjustHijriDays,
                    AdjustHijriDaysSpecified = true,
                    AlternateCalendarType = template.RegionalSettings.AlternateCalendarType.FromTemplateToSchemaCalendarTypeV201612(),
                    AlternateCalendarTypeSpecified = true,
                    CalendarType = template.RegionalSettings.CalendarType.FromTemplateToSchemaCalendarTypeV201612(),
                    CalendarTypeSpecified = true,
                    Collation = template.RegionalSettings.Collation,
                    CollationSpecified = true,
                    FirstDayOfWeek = (V201612.DayOfWeek)Enum.Parse(typeof(V201612.DayOfWeek), template.RegionalSettings.FirstDayOfWeek.ToString()),
                    ...
                    WorkDayEndHour = template.RegionalSettings.WorkDayEndHour.FromTemplateToSchemaWorkHourV201612(),
                    WorkDayEndHourSpecified = true,
                    WorkDays = template.RegionalSettings.WorkDays,
                    WorkDaysSpecified = true,
                    WorkDayStartHour = template.RegionalSettings.WorkDayStartHour.FromTemplateToSchemaWorkHourV201612(),
            ...
            if (template.SupportedUILanguages != null && template.SupportedUILanguages.Count > 0)
            {
                result.SupportedUILanguages =
                    (from l in template.SupportedUILanguages
                     select new V201612.SupportedUILanguagesSupportedUILanguage
                     {
                         LCID = l.LCID,
                     }).ToArray();
            }
            ...
            {
                result.AuditSettings = new V201612.AuditSettings
                {
                    ...
                    Audit = template.AuditSettings.AuditFlags.FromTemplateToSchemaAuditsV201612(),
                };
            }
            else
            {
            ...
            {
                result.Security = new V201612.Security();
                    ...
                    if (template.Security.SiteSecurityPermissions.RoleAssignments != null && template.Security.SiteSecurityPermissions.RoleAssignments.Count > 0)
                    {
                        result.Security.Permissions.RoleAssignments =
                            (from ra in template.Security.SiteSecurityPermissions.RoleAssignments
                             select new V201612.RoleAssignment
                             {
                    ...
                    if (template.Security.SiteSecurityPermissions.RoleDefinitions != null && template.Security.SiteSecurityPermissions.RoleDefinitions.Count > 0)
                    {
                        result.Security.Permissions.RoleDefinitions =
                            (from rd in template.Security.SiteSecurityPermissions.RoleDefinitions
                             select new V201612.RoleDefinition
                             {
            ...
            {
                result.Navigation = new V201612.Navigation
                {
                    GlobalNavigation =
                            ...
                            new NavigationGlobalNavigation
                            {
                                ...
                                StructuralNavigation =
                                    template.Navigation.GlobalNavigation.StructuralNavigation != null ?
                                        new V201612.StructuralNavigation
                                        {
                                            ...
                                            NavigationNode = (from n in template.Navigation.GlobalNavigation.StructuralNavigation.NavigationNodes
                                                              select n.FromModelNavigationNodeToSchemaNavigationNodeV201612()).ToArray()
                                        } : null,
                                ManagedNavigation =
                                    template.Navigation.GlobalNavigation.ManagedNavigation != null ?
                                        new V201612.ManagedNavigation
                                        {
            ...
            {
                result.SiteFields = new V201612.ProvisioningTemplateSiteFields
                {
                    Any =
            ...
            if (template.ContentTypes != null && template.ContentTypes.Count > 0)
            {
                result.ContentTypes =
                    (from ct in template.ContentTypes
                     select new V201612.ContentType
                     {
                         ID = ct.Id,
                         ...
                         (from fieldRef in ct.FieldRefs
                          select new V201612.ContentTypeFieldRef
                          {
                              Name = fieldRef.Name,
                         ...
                         DocumentSetTemplate = ct.DocumentSetTemplate != null ?
                             new V201612.DocumentSetTemplate
                             {
            ...
            if (template.Lists != null && template.Lists.Count > 0)
            {
                result.Lists =
                    (from list in template.Lists
                     select new V201612.ListInstance
                     {
                         ...
                         ContentTypeBindings = list.ContentTypeBindings.Count > 0 ?
                            (from contentTypeBinding in list.ContentTypeBindings
                             select new V201612.ContentTypeBinding
                             {
                         ...
                         new V201612.ListInstanceFields
                         {
                             Any =
                         ...
                         (from fieldRef in list.FieldRefs
                          select new V201612.ListInstanceFieldRef
                          {
                              Name = fieldRef.Name,
                         ...
                         DataRows = list.DataRows.Count > 0 ?
                            (from dr in list.DataRows
                             select new ListInstanceDataRow
                             {
                                 ...
                                 Security = dr.Security.FromTemplateToSchemaObjectSecurityV201612()
                             }).ToArray() : null,
                         Security = list.Security.FromTemplateToSchemaObjectSecurityV201612(),
                         Folders = list.Folders.Count > 0 ?
                         (from folder in list.Folders
                          select folder.FromTemplateToSchemaFolderV201612()).ToArray() : null,
                         UserCustomActions = list.UserCustomActions.Count > 0 ?
                         (from customAction in list.UserCustomActions
                          select new V201612.CustomAction
                          {
                              ...
                              Rights = customAction.Rights.FromBasePermissionsToStringV201612(),
            ...
            {
                result.Features = new V201612.Features();
            ...
            {
                result.CustomActions = new V201612.CustomActions();
                     ...
                     select new V201612.File
                     {
                         ...
                         WebParts = file.WebParts.Count > 0 ?
                            (from wp in file.WebParts
                             select new V201612.WebPartPageWebPart
                             {
                                 Zone = wp.Zone,
                                 Order = (int)wp.Order,
                         ...
                         Security = file.Security.FromTemplateToSchemaObjectSecurityV201612()
                     }).ToArray();
            }
            else
            {
            ...
            {
                var pages = new List<V201612.Page>();

                foreach (var page in template.Pages)
                {
                    var schemaPage = new V201612.Page();

                    var pageLayout = V201612.WikiPageLayout.OneColumn;
                    switch (page.Layout)
                    {
                        case WikiPageLayout.OneColumn:
                            pageLayout = V201612.WikiPageLayout.OneColumn;
                            break;
                        case WikiPageLayout.OneColumnSideBar:
                            pageLayout = V201612.WikiPageLayout.OneColumnSidebar;
                            break;
                        case WikiPageLayout.TwoColumns:
                            pageLayout = V201612.WikiPageLayout.TwoColumns;
                            break;
                        case WikiPageLayout.TwoColumnsHeader:
                            pageLayout = V201612.WikiPageLayout.TwoColumnsHeader;
                            break;
                        case WikiPageLayout.TwoColumnsHeaderFooter:
                            pageLayout = V201612.WikiPageLayout.TwoColumnsHeaderFooter;
                            break;
                        case WikiPageLayout.ThreeColumns:
                            pageLayout = V201612.WikiPageLayout.ThreeColumns;
                            break;
                        case WikiPageLayout.ThreeColumnsHeader:
                            pageLayout = V201612.WikiPageLayout.ThreeColumnsHeader;
                            break;
                        case WikiPageLayout.ThreeColumnsHeaderFooter:
                            pageLayout = V201612.WikiPageLayout.ThreeColumnsHeaderFooter;
                            break;
                        case WikiPageLayout.Custom:
                            pageLayout = V201612.WikiPageLayout.Custom;
                            break;
                    }
                    schemaPage.Layout = pageLayout;
                    schemaPage.Overwrite = page.Overwrite;
                    schemaPage.Security = (page.Security != null) ? page.Security.FromTemplateToSchemaObjectSecurityV201612() : null;

                    schemaPage.WebParts = page.WebParts.Count > 0 ?
                        (from wp in page.WebParts
                         select new V201612.WikiPageWebPart
                         {
                    ...
                    schemaPage.Fields = (page.Fields != null && page.Fields.Count > 0) ?
                                (from f in page.Fields
                                 select new V201612.BaseFieldValue
                                 {
                                     FieldName = f.Key,
                                     Value = f.Value,
                                 }).ToArray() : null;
                    ...
                    (from grp in template.TermGroups
                     select new V201612.TermGroup
                     {
                         ...
                         Contributors = (from c in grp.Contributors
                                         select new V201612.User { Name = c.Name }).ToArray(),
                         Managers = (from m in grp.Managers
                                     select new V201612.User { Name = m.Name }).ToArray(),
                         TermSets = (
                            from termSet in grp.TermSets
                            select new V201612.TermSet
                            {
                                ...
                                Terms = termSet.Terms.FromModelTermsToSchemaTermsV201612(),
            ...
            {
                result.ComposedLook = new V201612.ComposedLook
                {
            ...
            {
                result.Workflows = new V201612.Workflows
                {
                    WorkflowDefinitions = template.Workflows.WorkflowDefinitions.Count > 0 ?
                        (from wd in template.Workflows.WorkflowDefinitions
                         select new WorkflowsWorkflowDefinition
                         {
                             ...
                             RestrictToType = (V201612.WorkflowsWorkflowDefinitionRestrictToType)Enum.Parse(typeof(V201612.WorkflowsWorkflowDefinitionRestrictToType), wd.RestrictToType),
            ...
            {
                result.Publishing = new V201612.Publishing
                {
                    AutoCheckRequirements = (V201612.PublishingAutoCheckRequirements)Enum.Parse(typeof(V201612.PublishingAutoCheckRequirements), template.Publishing.AutoCheckRequirements.ToString()),
                    AvailableWebTemplates = template.Publishing.AvailableWebTemplates.Count > 0 ?
                        (from awt in template.Publishing.AvailableWebTemplates
                         select new V201612.PublishingWebTemplate
                         {
                             LanguageCode = awt.LanguageCode,
                             LanguageCodeSpecified = true,
                             TemplateName = awt.TemplateName,
                         }).ToArray() : null,
                    DesignPackage = template.Publishing.DesignPackage != null ? new V201612.PublishingDesignPackage
                    {
                    ...
                    PublishingPages = template.Publishing.PublishingPages != null && template.Publishing.PublishingPages.Count > 0 ?
                        (from pp in template.Publishing.PublishingPages
                            select new V201612.PublishingPublishingPage
                            {
                                ...
                                Properties = pp.Properties != null && pp.Properties.Any() ?
                                (from p in pp.Properties
                                select new V201612.StringDictionaryItem
                                {
                                    Key = p.Key,
                                    Value = p.Value
                                }).ToArray() : null,
                                WebParts = pp.WebParts != null && pp.WebParts.Count > 0 ? 
                                (from wp in pp.WebParts
                                select new V201612.PublishingWebPartPageWebPart
                                {
                                    Contents = XElement.Parse(wp.Contents).ToXmlElement(),
            ...
            if (template.AddIns != null && template.AddIns.Count > 0)
            {
                result.AddIns =
                    (from addin in template.AddIns
                     select new V201612.AddInsAddin
                     {
                         PackagePath = addin.PackagePath,
                         Source = (V201612.AddInsAddinSource)Enum.Parse(typeof(V201612.AddInsAddinSource), addin.Source),
                     }).ToArray();
            }
            else
            {
            ...
            var output = XMLSerializer.SerializeToStream<V201612.Provisioning>(wrappedResult, ns);
            output.Position = 0;
            return (output);
        }
    ...
    internal static class V201612Extensions
    {
        public static V201612.Term[] FromModelTermsToSchemaTermsV201612(this TermCollection terms)
        {
            V201612.Term[] result = terms.Count > 0 ? (
                from term in terms
                select new V201612.Term
                {
                    ...
                    Terms = term.Terms.Count > 0 ? new V201612.TermTerms { Items = term.Terms.FromModelTermsToSchemaTermsV201612() } : null,
                    ...
                    Labels = term.Labels.Count > 0 ?
                        (from l in term.Labels
                         select new V201612.TermLabelsLabel
                         {
                             Language = l.Language,
        ...
        public static List<Model.Term> FromSchemaTermsToModelTermsV201612(this V201612.Term[] terms)
        {
            List<Model.Term> result = new List<Model.Term>(
                ...
                select new Model.Term(
                    ...
                    (term.Terms != null && term.Terms.Items != null) ? term.Terms.Items.FromSchemaTermsToModelTermsV201612() : null,
                    term.Labels != null ?
        ...
        public static V201612.CalendarType FromTemplateToSchemaCalendarTypeV201612(this Microsoft.SharePoint.Client.CalendarType calendarType)
        {
            switch (calendarType)
            {
                case Microsoft.SharePoint.Client.CalendarType.ChineseLunar:
                    return V201612.CalendarType.ChineseLunar;
                case Microsoft.SharePoint.Client.CalendarType.Gregorian:
                    return V201612.CalendarType.Gregorian;
                case Microsoft.SharePoint.Client.CalendarType.GregorianArabic:
                    return V201612.CalendarType.GregorianArabicCalendar;
                case Microsoft.SharePoint.Client.CalendarType.GregorianMEFrench:
                    return V201612.CalendarType.GregorianMiddleEastFrenchCalendar;
                case Microsoft.SharePoint.Client.CalendarType.GregorianXLITEnglish:
                    return V201612.CalendarType.GregorianTransliteratedEnglishCalendar;
                case Microsoft.SharePoint.Client.CalendarType.GregorianXLITFrench:
                    return V201612.CalendarType.GregorianTransliteratedFrenchCalendar;
                case Microsoft.SharePoint.Client.CalendarType.Hebrew:
                    return V201612.CalendarType.Hebrew;
                case Microsoft.SharePoint.Client.CalendarType.Hijri:
                    return V201612.CalendarType.Hijri;
                case Microsoft.SharePoint.Client.CalendarType.Japan:
                    return V201612.CalendarType.Japan;
                case Microsoft.SharePoint.Client.CalendarType.Korea:
                    return V201612.CalendarType.Korea;
                case Microsoft.SharePoint.Client.CalendarType.KoreaJapanLunar:
                    return V201612.CalendarType.KoreaandJapaneseLunar;
                case Microsoft.SharePoint.Client.CalendarType.SakaEra:
                    return V201612.CalendarType.SakaEra;
                case Microsoft.SharePoint.Client.CalendarType.Taiwan:
                    return V201612.CalendarType.Taiwan;
                case Microsoft.SharePoint.Client.CalendarType.Thai:
                    return V201612.CalendarType.Thai;
                case Microsoft.SharePoint.Client.CalendarType.UmAlQura:
                    return V201612.CalendarType.UmmalQura;
                case Microsoft.SharePoint.Client.CalendarType.None:
                default:
                    return V201612.CalendarType.None;
            }
        }

        public static Microsoft.SharePoint.Client.CalendarType FromSchemaToTemplateCalendarTypeV201612(this V201612.CalendarType calendarType)
        {
            switch (calendarType)
            {
                case V201612.CalendarType.ChineseLunar:
                    return Microsoft.SharePoint.Client.CalendarType.ChineseLunar;
                case V201612.CalendarType.Gregorian:
                    return Microsoft.SharePoint.Client.CalendarType.Gregorian;
                case V201612.CalendarType.GregorianArabicCalendar:
                    return Microsoft.SharePoint.Client.CalendarType.GregorianArabic;
                case V201612.CalendarType.GregorianMiddleEastFrenchCalendar:
                    return Microsoft.SharePoint.Client.CalendarType.GregorianMEFrench;
                case V201612.CalendarType.GregorianTransliteratedEnglishCalendar:
                    return Microsoft.SharePoint.Client.CalendarType.GregorianXLITEnglish;
                case V201612.CalendarType.GregorianTransliteratedFrenchCalendar:
                    return Microsoft.SharePoint.Client.CalendarType.GregorianXLITFrench;
                case V201612.CalendarType.Hebrew:
                    return Microsoft.SharePoint.Client.CalendarType.Hebrew;
                case V201612.CalendarType.Hijri:
                    return Microsoft.SharePoint.Client.CalendarType.Hijri;
                case V201612.CalendarType.Japan:
                    return Microsoft.SharePoint.Client.CalendarType.Japan;
                case V201612.CalendarType.Korea:
                    return Microsoft.SharePoint.Client.CalendarType.Korea;
                case V201612.CalendarType.KoreaandJapaneseLunar:
                    return Microsoft.SharePoint.Client.CalendarType.KoreaJapanLunar;
                case V201612.CalendarType.SakaEra:
                    return Microsoft.SharePoint.Client.CalendarType.SakaEra;
                case V201612.CalendarType.Taiwan:
                    return Microsoft.SharePoint.Client.CalendarType.Taiwan;
                case V201612.CalendarType.Thai:
                    return Microsoft.SharePoint.Client.CalendarType.Thai;
                case V201612.CalendarType.UmmalQura:
                    return Microsoft.SharePoint.Client.CalendarType.UmAlQura;
                case V201612.CalendarType.None:
                default:
                    return Microsoft.SharePoint.Client.CalendarType.None;
            }
        }

        public static V201612.WorkHour FromTemplateToSchemaWorkHourV201612(this Model.WorkHour workHour)
        {
            switch (workHour)
            {
                case Model.WorkHour.AM0100:
                    return V201612.WorkHour.Item100AM;
                case Model.WorkHour.AM0200:
                    return V201612.WorkHour.Item200AM;
                case Model.WorkHour.AM0300:
                    return V201612.WorkHour.Item300AM;
                case Model.WorkHour.AM0400:
                    return V201612.WorkHour.Item400AM;
                case Model.WorkHour.AM0500:
                    return V201612.WorkHour.Item500AM;
                case Model.WorkHour.AM0600:
                    return V201612.WorkHour.Item600AM;
                case Model.WorkHour.AM0700:
                    return V201612.WorkHour.Item700AM;
                case Model.WorkHour.AM0800:
                    return V201612.WorkHour.Item800AM;
                case Model.WorkHour.AM0900:
                    return V201612.WorkHour.Item900AM;
                case Model.WorkHour.AM1000:
                    return V201612.WorkHour.Item1000AM;
                case Model.WorkHour.AM1100:
                    return V201612.WorkHour.Item1100AM;
                case Model.WorkHour.AM1200:
                    return V201612.WorkHour.Item1200AM;
                case Model.WorkHour.PM0100:
                    return V201612.WorkHour.Item100PM;
                case Model.WorkHour.PM0200:
                    return V201612.WorkHour.Item200PM;
                case Model.WorkHour.PM0300:
                    return V201612.WorkHour.Item300PM;
                case Model.WorkHour.PM0400:
                    return V201612.WorkHour.Item400PM;
                case Model.WorkHour.PM0500:
                    return V201612.WorkHour.Item500PM;
                case Model.WorkHour.PM0600:
                    return V201612.WorkHour.Item600PM;
                case Model.WorkHour.PM0700:
                    return V201612.WorkHour.Item700PM;
                case Model.WorkHour.PM0800:
                    return V201612.WorkHour.Item800PM;
                case Model.WorkHour.PM0900:
                    return V201612.WorkHour.Item900PM;
                case Model.WorkHour.PM1000:
                    return V201612.WorkHour.Item1000PM;
                case Model.WorkHour.PM1100:
                    return V201612.WorkHour.Item1100PM;
                case Model.WorkHour.PM1200:
                    return V201612.WorkHour.Item1200PM;
                default:
                    return V201612.WorkHour.Item100AM;
            }
        }

        public static Model.WorkHour FromSchemaToTemplateWorkHourV201612(this V201612.WorkHour workHour)
        {
            switch (workHour)
            {
                case V201612.WorkHour.Item100AM:
                    return Model.WorkHour.AM0100;
                case V201612.WorkHour.Item200AM:
                    return Model.WorkHour.AM0200;
                case V201612.WorkHour.Item300AM:
                    return Model.WorkHour.AM0300;
                case V201612.WorkHour.Item400AM:
                    return Model.WorkHour.AM0400;
                case V201612.WorkHour.Item500AM:
                    return Model.WorkHour.AM0500;
                case V201612.WorkHour.Item600AM:
                    return Model.WorkHour.AM0600;
                case V201612.WorkHour.Item700AM:
                    return Model.WorkHour.AM0700;
                case V201612.WorkHour.Item800AM:
                    return Model.WorkHour.AM0800;
                case V201612.WorkHour.Item900AM:
                    return Model.WorkHour.AM0900;
                case V201612.WorkHour.Item1000AM:
                    return Model.WorkHour.AM1000;
                case V201612.WorkHour.Item1100AM:
                    return Model.WorkHour.AM1100;
                case V201612.WorkHour.Item1200AM:
                    return Model.WorkHour.AM1200;
                case V201612.WorkHour.Item100PM:
                    return Model.WorkHour.PM0100;
                case V201612.WorkHour.Item200PM:
                    return Model.WorkHour.PM0200;
                case V201612.WorkHour.Item300PM:
                    return Model.WorkHour.PM0300;
                case V201612.WorkHour.Item400PM:
                    return Model.WorkHour.PM0400;
                case V201612.WorkHour.Item500PM:
                    return Model.WorkHour.PM0500;
                case V201612.WorkHour.Item600PM:
                    return Model.WorkHour.PM0600;
                case V201612.WorkHour.Item700PM:
                    return Model.WorkHour.PM0700;
                case V201612.WorkHour.Item800PM:
                    return Model.WorkHour.PM0800;
                case V201612.WorkHour.Item900PM:
                    return Model.WorkHour.PM0900;
                case V201612.WorkHour.Item1000PM:
                    return Model.WorkHour.PM1000;
                case V201612.WorkHour.Item1100PM:
                    return Model.WorkHour.PM1100;
                case V201612.WorkHour.Item1200PM:
        ...
        public static V201612.AuditSettingsAudit[] FromTemplateToSchemaAuditsV201612(this Microsoft.SharePoint.Client.AuditMaskType audits)
        {
            List<V201612.AuditSettingsAudit> result = new List<AuditSettingsAudit>();
        ...
        public static Model.ObjectSecurity FromSchemaToTemplateObjectSecurityV201612(this V201612.ObjectSecurity objectSecurity)
        {
        ...
        public static V201612.ObjectSecurity FromTemplateToSchemaObjectSecurityV201612(this Model.ObjectSecurity objectSecurity)
        {
            return ((objectSecurity != null && (objectSecurity.ClearSubscopes == true || objectSecurity.CopyRoleAssignments == true || objectSecurity.RoleAssignments.Count > 0)) ?
                new V201612.ObjectSecurity
                {
                    BreakRoleInheritance = new V201612.ObjectSecurityBreakRoleInheritance
                    {
        ...
        public static V201612.Folder FromTemplateToSchemaFolderV201612(this Model.Folder folder)
        {
            V201612.Folder result = new V201612.Folder();
            result.Name = folder.Name;
            result.Security = folder.Security.FromTemplateToSchemaObjectSecurityV201612();
            result.Folder1 = folder.Folders != null ? (from child in folder.Folders select child.FromTemplateToSchemaFolderV201612()).ToArray() : null;
            return (result);
        }

        public static string FromBasePermissionsToStringV201612(this BasePermissions basePermissions)
        {
        ...
        public static V201612.NavigationNode FromModelNavigationNodeToSchemaNavigationNodeV201612(
            this Model.NavigationNode node)
        {
            var result = new V201612.NavigationNode
            {
                IsExternal = node.IsExternal,
                Title = node.Title,
                Url = node.Url,
                NavigationNode1 = (from n in node.NavigationNodes
                              select n.FromModelNavigationNodeToSchemaNavigationNodeV201612()).ToArray()
            };
