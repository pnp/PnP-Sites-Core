...
namespace OfficeDevPnP.Core.Pages
{
    ...
    public class CanvasSection
    {
        ...
        /// <param name="zoneemphasis">ZoneEmphasis of this section in the collection of sections on the page</param>
        public CanvasSection(ClientSidePage page, CanvasSectionTemplate canvasSectionTemplate, float order, int zoneemphasis=0)
        {
            if (page == null)
            {
                throw new ArgumentNullException("Passed page cannot be null");
